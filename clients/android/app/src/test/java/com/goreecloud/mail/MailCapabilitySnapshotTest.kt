...
class MailCapabilitySnapshotTest {
    ...
    fun sourceContractsAreReadyButRuntimeRemainsBlocked() {
        ...
        assertEquals(MailCapabilityState.SOURCE_READY, snapshot.identityRegistrationContract.state)
        ...
        assertTrue(snapshot.identityRegistrationContract.explanation.contains("no runtime registrations"))
        assertTrue(snapshot.identityRegistrationContract.explanation.contains("remain blocked"))
